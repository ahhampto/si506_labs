...
#alternative: '?search=darth+vader'

vader = requests.get(resource_uri, params).json()
#alternative: vader = requests.get(resource_uri, {'search': 'darth vader'}).json()
#print(vader)
...
#film = requests.get("https://swapi.co/api/films/3/").json()
#print(film)
